  ...
  third: [
    {
      ...
      rank: 1,
      castId: 'km_hot_sara',
      size: 'Age.31 / T.155 / B.87 [G] / W.59 / H.88',
    },
    { id: 2, rank: 2, castId: 'fu_villa_kana' },
    { id: 3, rank: 3, castId: 'km_hot_mio' },
    { id: 4, rank: 4, castId: 'km_hot_ran' },
    { id: 5, rank: 5, castId: 'kt_lip_momoka' },
    { id: 6, rank: 6, castId: 'km_hot_anri' },
    { id: 7, rank: 7, castId: 'kt_hot_himeno' },
    { id: 8, rank: 8, castId: 'kt_part2_mai' },
    { id: 9, rank: 9, castId: 'fu_hot_arisu' },
    { id: 10, rank: 10, castId: 'kt_part2_rika' },
    { id: 11, rank: 11, castId: 'fu_villa_ren' },
    { id: 12, rank: 12, castId: 'yh_dandy_seri' },
    { id: 13, rank: 13, castId: 'km_hot_rui' },
    { id: 14, rank: 14, castId: 'km_hot_yua' },
    { id: 15, rank: 15, castId: 'km_villa_sena' },
    { id: 16, rank: 16, castId: 'yh_dandy_niko' },
  ...
  fourth: [
    {
      ...
      rank: 1,
      castId: 'kb_hot_rion',
      size: 'Age.23 / T.157 / B.82 [B] / W.58 / H.84',
    },
    { id: 2, rank: 2, castId: 'fu_villa_kana' },
    { id: 3, rank: 3, castId: 'km_hot_mio' },
    { id: 4, rank: 4, castId: 'km_hot_ran' },
    { id: 5, rank: 5, castId: 'yh_dandy_seri' },
    { id: 6, rank: 6, castId: 'km_hot_anri' },
    { id: 7, rank: 7, castId: 'km_hot_saya' },
    { id: 8, rank: 8, castId: 'kt_part2_mai' },
    { id: 9, rank: 9, castId: 'km_hot_sara' },
    { id: 10, rank: 10, castId: 'fu_villa_ren' },
    { id: 11, rank: 11, castId: 'fu_villa_hikaru' },
    { id: 12, rank: 12, castId: 'kt_lip_aina' },
    { id: 13, rank: 13, castId: 'km_villa_madoka' },
    { id: 14, rank: 14, castId: 'fu_hot_arisu' },
    { id: 15, rank: 15, castId: 'kt_part2_sakura' },
    { id: 16, rank: 16, castId: 'yh_mr_rin' },
    { id: 17, rank: 17, castId: 'kb_hot_kazuha' },
    { id: 18, rank: 18, castId: 'fu_hot_koume' },
    { id: 19, rank: 19, castId: 'km_hot_rui' },
    { id: 20, rank: 20, castId: 'km_hot_erena' },
  ],
};
